...
\newpage
\section{AI Usage}
The use of generative AI was within class guidlines as outlined in the sylabus. It was used heavily to check sytax and coding logic during development by pasting given errors and lines of code in question into the chat. In those cases where code was directly passed to the chat  the phrase, " without editing the code..." was used. The heaviest use was in the creation of proper latex sytax for tables and fugures to ensure a clean and readable document. The primary model used was Gemini 3 with some use of Copilot.
