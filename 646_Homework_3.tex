...
The python implementation can be found in the appendix as well as accompanying files. the primary hyperparameters in question for us are $\bar{Q}_0$ the optimistic initial action-value estimate, $\epsilon_a$ the initial exploration rate, and $\epsilon_b$ the terminal exploration rate. 
\end{document}